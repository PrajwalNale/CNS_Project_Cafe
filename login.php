...
<style type="text/css">
  body {
    background-image: url("https://img.theculturetrip.com/840x440/smart/wp-content/uploads/2018/02/coffee-3120750_1280-1.jpg") !important;
    background-size: cover;
  }

  .full-page.login-page, .full-page.pricing-page, .full-page.register-page {
    min-height: 100vh;
    background: radial-gradient(#1e1e2f87,#1e1e24) !important;
}
</style>
<head>
  <meta charset="utf-8" />
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright">
            ...
            <a href="javascript:void(0)" target="_blank">Ashish&Shreyas</a> for a better Future.
          </div>
        </div>
      </footer>
    </div>
